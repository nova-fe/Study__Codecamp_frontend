...
import { FetchAllKeysResponse, FetchPostsByKeyResponse } from '@/schemas';
...
export default function StaticRoutingMovedPage() {
  const [data, setData] = useState<FetchPostsByKeyResponse>(); // 게시글 데이터
  const [keyList, setKeyList] = useState<FetchAllKeysResponse>([]); // key 목록
