...
const BoardsNew = () => {
  ...
  const onChangePassword = e => {
    ...
    if (writer && e.target.value && title && content) return setIsActive(true);
    setIsActive(false);
  };
  ...
  const onChangeTitle = e => {
    ...
    if (writer && password && e.target.value && content)
      return setIsActive(true);
    setIsActive(false);
  };
  ...
  const onChangeContent = e => {
    ...
    if (writer && password && title && e.target.value) return setIsActive(true);
    setIsActive(false);
  };
